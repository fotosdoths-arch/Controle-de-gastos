# Controle-de-gastos[index.html.html](https://github.com/user-attachments/files/28371285/index.html.html)
<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
...
<aside class="sidebar" id="sidebar">
  ...
  <nav>
    ...
    <div class="nav-item" onclick="showSection('reset')" style="margin-top:auto;color:var(--red);border-top:1px solid var(--border)"><span class="nav-icon">🗑️</span><span>Zerar dados</span></div>
  </nav>
</aside>
